...
class DocSAM(nn.Module):
    ...
    def __init__(self, model_size="base", mask2former_path=None, sentence_path=None):
        ...
        # New precedence: explicit argument -> fallback scan.
        ...
        # Keep these for traceability/debugging in wrapper metadata if needed.
        self.mask2former_path = str(mask2former_path)
        self.sentence_path = str(sentence_path)
